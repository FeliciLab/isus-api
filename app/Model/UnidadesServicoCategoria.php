...
class UnidadesServicoCategoria extends Model
{
    ...
    public const WORDPRESS_CATEGORIA_UTI = 709;
    public const WORDPRESS_CATEGORIAS_VALIDAS = [self::WORDPRESS_CATEGORIA_ADMINISTRACAO_E_GESTAO, self::WORDPRESS_CATEGORIA_UTI];
